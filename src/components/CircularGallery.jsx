...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#d1d5db', font = '30px sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
export default function CircularGallery({
  ...
  return <div className="w-full md:h-110 lg:h-130 h-50 overflow-hidden cursor-grab active:cursor-grabbing text-[#0055ff] -z-50 " ref={containerRef} />;
}
